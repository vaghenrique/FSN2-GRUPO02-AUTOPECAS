      ...
      <div id="main">
        <div className="inner">
          ...
          <section>
            ...
            <span className="image main"><img src="images/produto5.png" alt="Produto" /></span>
            ...
            <div className="mini-posts">
              <article>
                <Link to="/p6" className="image"><img src="images/produto6.png" alt="Produto 2" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p7" className="image"><img src="images/produto7.png" alt="Produto 3" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p8" className="image"><img src="images/produto8.png" alt="Produto 4" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
            </div>
          </section>
