        ...
        <div className="inner">
          ...
          <section>
            ...
            <div className="mini-posts">
              <article>
                <Link to="/p26" className="image"><img src="images/produto2.jpg" alt="Produto 2" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p27" className="image"><img src="images/produto3.jpg" alt="Produto 3" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p28" className="image"><img src="images/produto4.jpg" alt="Produto 4" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
            </div>
          </section>
