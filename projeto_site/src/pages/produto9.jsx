        ...
        <div className="inner">
          ...
          <section>
            ...
            <div className="mini-posts">
              <article>
                <Link to="/p10" className="image"><img src="images/produto2.jpg" alt="Produto 2" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p11" className="image"><img src="images/produto3.jpg" alt="Produto 3" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
              <article>
                <Link to="/p12" className="image"><img src="images/produto4.jpg" alt="Produto 4" /></Link>
                <p>Breve descrição do produto relacionado.</p>
              </article>
            </div>
          </section>
