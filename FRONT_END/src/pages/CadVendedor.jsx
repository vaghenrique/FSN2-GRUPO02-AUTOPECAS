...
function CadVendedor() {
  ...
  async function criarVendedor(e) {
    e.preventDefault();
    console.log("dados enviados:", {
      email: inputEmail.current.value,
      senha: inputSenha.current.value
    })
    await api.post('/cad_vendedor', {
      email: inputEmail.current.value,
      senha: inputSenha.current.value
    })
          ...
          <div id="main">
            <div class="inner">
                ...
                <header id="header">
                  ...
                  <ul class="icons">
                    <li><Link to='/login_vendedor' className="logo">Já possui cadastro na plataforma?</Link></li>
                  </ul>
                </header>

                <section>
                <div class="cad_area">
                  <h2 id="h2_cad">Cadastre-se como vendedor em nosso Site</h2>
                  <div className="form">
                    <form>
                      <div class="cad_dados">
                      ...
                      <div id="teste">
                      <button type="submit" class="teste" onClick={criarVendedor}>Cadastrar</button>
                      </div>
                    </form>
                  </div>
                </div>
